    ...
    public class EzForagingPathfinder {
        ...
        public static List<BlockPos> findPath(Level level, BlockPos start, BlockPos end, int maxIterations, Set<BlockPos> blacklist) {
            PriorityQueue<Node> openSet= new PriorityQueue<>(Comparator.comparing(node -> node.fCost));
            Set<BlockPos> closedSet = new HashSet<>(blacklist);
